...
const isSquare = require('./labWork-2');
...
class Mtrx extends Array {
  ...
  static isSameShape(obj, another) {
    return isSameShape(obj, another);
  }

  static equal(matrix, another) {
    return toArray(isEqualWith(matrix, another, map));
  }
  static equalAll(matrix, another) {
    return isEqualWith(matrix, another, every);
  }
  static equalAny(matrix, another) {
    return isEqualWith(matrix, another, some);
  }
